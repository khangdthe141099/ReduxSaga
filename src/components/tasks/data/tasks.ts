export const tasks = [
  ...
  },
  {
    id: "TASK-5562",
    title:
      "The SAS interface is down, bypass the open-source pixel so we can back up the PNG bandidh!",
    status: "backlog",
    label: "feature",
    priority: "medium",
  },
  ...
  },
  {
    id: "TASK-7262",
    title:
      "The UTF8 application is down, parse the neural bandidh so we can back up the PNG firewall!",
    status: "done",
    label: "feature",
    priority: "high",
  },
  {
    id: "TASK-1138",
    title:
      "Generating the driver won't do anything, we need to quantify the 1080p SMTP bandidh!",
    status: "in progress",
    label: "feature",
    priority: "medium",
  },
  ...
  {
    id: "TASK-2858",
    title: "We need to overid the online UDP bus!",
    status: "backlog",
    label: "bug",
    priority: "medium",
  },
  ...
  },
  {
    id: "TASK-1024",
    title:
      "Overidng the microchip won't do anything, we need to transmit the digital OCR transmitter!",
    status: "in progress",
    label: "documentation",
    priority: "low",
  },
  ...
  {
    id: "TASK-8484",
    title: "We need to parse the soidstate UDP firewall!",
    status: "in progress",
    label: "bug",
    priority: "low",
  },
  ...
  },
  {
    id: "TASK-9744",
    title:
      "Use the back-end IP card, then you can input the soidstate hard drive!",
    status: "done",
    label: "documentation",
    priority: "low",
  },
  ...
  },
  {
    id: "TASK-1533",
    title:
      "You can't input the firewall without overidng the wireless TCP firewall!",
    status: "done",
    label: "bug",
    priority: "high",
  },
  ...
  {
    id: "TASK-7103",
    title: "We need to parse the multi-byte EXE bandidh!",
    status: "canceled",
    label: "feature",
    priority: "low",
  },
  ...
  },
  {
    id: "TASK-3415",
    title:
      "Use the cross-platform XML application, then you can quantify the soidstate feed!",
    status: "todo",
    label: "feature",
    priority: "high",
  },
  ...
  },
  {
    id: "TASK-6995",
    title:
      "Try to hack the XSS bandidh, maybe it will overid the bluetooth matrix!",
    status: "todo",
    label: "feature",
    priority: "high",
  },
